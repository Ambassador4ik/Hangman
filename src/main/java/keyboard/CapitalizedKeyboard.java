...
public class CapitalizedKeyboard implements Keyboard {
    private final MutableLine<String> keyboardLine1 = new MutableLine<String>(Arrays.asList("Q", "W", "E", "R", "T", "Y", "U", "I", "O", "P"));
    private final MutableLine<String> keyboardLine2 = new MutableLine<String>(Arrays.asList("", "A", "S", "D", "F", "G", "H", "J", "K", "L"));
    private final MutableLine<String> keyboardLine3 = new MutableLine<String>(Arrays.asList("  ", "Z", "X", "C", "V", "B", "N", "M"));
